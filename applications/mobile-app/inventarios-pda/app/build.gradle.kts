...
fun releaseSigningProperty(name: String): String =
    releaseSigningProperties.getProperty(name)
        ?: releaseSigningProperties.getProperty("\uFEFF$name")
        ?: error("Missing '$name' in signing.properties")

android {
    namespace = "com.allstar.pda"
    compileSdk = 36
...
firebaseAppDistribution {
    releaseNotes = "Nueva versión de la app de inventario"
    groups = "equipo-inventario"  // nombre del grupo de testers
}
*/
