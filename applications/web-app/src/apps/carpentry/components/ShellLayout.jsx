...
const IconDocumentos = () => (
    <svg viewBox="0 0 24 24"><path d="M6 2h8l4 4v16H6z"/><path d="M14 2v5h5"/><path d="M9 12h6"/><path d="M9 16h6"/></svg>
);
...
const items = [
    ...
    { to: carpentryPath('documentos'), label: 'Documentos',     Icon: IconDocumentos },
                    ...
                    {items.map(({ to, label, Icon, disabled }) => {
                        ...
                        return (
                            <NavLink
                                key={to}
                                to={to}
                                end={to === carpentryPath('proyectos')}
