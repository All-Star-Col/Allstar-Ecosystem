...
async def get_role_permissions(
    ...
    if role_data_viewer_tables_columns:
        ...
        can_delete_column = _quote_identifier(
            str(role_data_viewer_tables_columns["can_delete"])
        )
        ...
        role_permissions_query = text(
            ...
            SELECT
                ...
                COALESCE({can_delete_column}, false) AS can_delete,
...
async def upsert_role_permissions(
    ...
    if role_data_viewer_tables_columns:
        ...
        update_assignments = [
            ...
            f"{can_delete_column} = EXCLUDED.{can_delete_column}",
