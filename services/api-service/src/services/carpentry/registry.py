...
ACTION_MAP = {
    ...
    "documentos.listar": documentos.listar_documentos,
    "documentos.cotizacion.aprobar": documentos.aprobar_cotizacion,
    ...
    "lotes.documentosOrdenCorte": lotes.listar_documentos_ordenes_corte,
    "lotes.ordenCorte.previsualizar": lotes.previsualizar_lote_desde_orden_corte,
    "lotes.ordenCorte.crear": lotes.crear_lote_desde_orden_corte,
    "lotes.materialRequerido.listar": lotes.listar_material_requerido_lote,
    "lotes.materialRequerido.guardar": lotes.guardar_material_requerido_lote,
    "lotes.materialRequerido.eliminar": lotes.eliminar_material_requerido_lote,
    "items.listarPorProyecto": bom.listar_items_por_proyecto,
    "items.crear": bom.crear_item,
    "items.crearBulk": bom.crear_items_bulk,
    "items.crearDesdeCotizacionAprobada": bom.crear_items_desde_cotizacion_aprobada,
    ...
    "bom.subitems.listar": bom.listar_subitems_por_item,
    "bom.subitems.crear": bom.crear_subitem,
    "bom.piezas.listar": bom.listar_piezas_por_item,
    "bom.piezas.asignarSubitem": bom.asignar_subitem_pieza,
